...
public class WithoutAnnotations implements TestClass {
    ...
    public WithoutAnnotations(FirstDependency firstDependency) {
        this.firstDependency = firstDependency;
        setId();
    }

    public WithoutAnnotations(FirstDependency firstDependency, SecondDependency secondDependency) {
        this.firstDependency = firstDependency;
    ...
    public boolean equals(Object o) {
        ...
        WithoutAnnotations that = (WithoutAnnotations) o;
